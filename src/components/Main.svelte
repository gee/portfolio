	...
	let benefits = [
		{
			...
			description: 'I taught myself to code using free online resources...'
		},
		{ name: 'a product design & UX fanatic', description: 'Carefully crafting and designing...' },
		{ name: 'an excellent communicator', description: 'Communication is key...' }
	];
</script>
	...
	<section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
		<div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
			<h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
				Hi! I'm <span class="poppins text-violet-400">Samuel</span> Oak <br />Full Stack
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
			...
			<Step step={steps[1]}
				><p>
					...
					> CRUD application that allows a user to login, manage a tidy and efficacious todo list...
				</p></Step
			>
			<Step step={steps[2]}
				><p>
					The Pokedex is a <strong class="text-violet-400">SvelteKit & TailwindCSS</strong> web application,
					hosted...
				</p></Step
			>
		</div>
		...
		<div class="flex flex-col overflow-x-scroll gap-10 max-w-[800px] mx-auto w-full">
			<table class="bg-white text-slate-700 rounded text-center">
				<thead class="border-b border-solid border-slate-200">
					<tr class="">
						<th />
						<th class="whitespace-nowrap p-2 px-4">Candiate #1</th>
						<th class="whitespace-nowrap p-2 px-4">Candiate #2</th>
						<th class="whitespace-nowrap p-2 px-4">Candiate #3</th>

		...
		<div>
			<p class="mb-4">
				...
				<a
					...
					target="_blank"
					rel="noreferrer noopener"
					aria-label="student-led design studio (opens in a new tab)">student-led design studio</a
				>, and a<!-- -->
				<a
					class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
					...
					>
						...
						<div class="z-10 sm:col-span-6">
							...
							<p class="mt-2 text-sm leading-normal">
								...
								create new brands, design systems, and websites for organizations in the community.
							</p>
							<ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
								<li class="mr-1.5 mt-2">
									<div
					...
					>
						...
						<div class="z-10 sm:order-2 sm:col-span-6">
							...
							<a
								...
								target="_blank"
								rel="noreferrer noopener"
								aria-label="585 stars on GitHub (opens in a new tab)"
								><svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 20 20"
									fill="currentColor"
					...
					>
						...
						<div class="z-10 sm:order-2 sm:col-span-6">
							...
							<a
								...
								target="_blank"
								rel="noreferrer noopener"
								aria-label="6806 stars on GitHub (opens in a new tab)"
								><svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 20 20"
									fill="currentColor"
